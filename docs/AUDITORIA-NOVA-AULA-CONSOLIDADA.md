# AUDITORIA PEDAGÓGICA CONSOLIDADA — MÓDULO "NOVA AULA" (MusiLab)

**Versão:** Consolidada (2026-03-17 + 2026-03-18)
**Solicitado por:** Rodrigo Ribeiro
**Autoria:** Claude Sonnet 4.6

> Este documento reúne **todas** as análises realizadas sobre o formulário "Nova Aula" do MusiLab em dois dias de trabalho. A **Parte I** contém o diagnóstico rápido e objetivo da primeira auditoria. A **Parte II** contém a auditoria profunda e academicamente fundamentada da segunda auditoria — com 27 autores e frameworks pedagógicos, análise campo a campo, e proposta de reestruturação completa. A **Parte III** contém o adendo com 11 autores adicionais identificados em pesquisa posterior.

---

# PARTE I — DIAGNÓSTICO RÁPIDO
*Auditoria de 2026-03-17 | Autores consultados: Tyler, Bloom, Hunter, Libâneo, Vasconcellos, Gandin, Swanwick, Elliott, Wiggins/McTighe, Sweller*

---

## I.1 MAPA DO FORMULÁRIO ATUAL (visão geral)

### Campos fixos
| Campo | Obrigatório | Problema identificado |
|-------|-------------|----------------------|
...
### Accordions
| Accordion | Modo | Problema principal |
|-----------|------|-------------------|
| 1 — Roteiro de Atividades | Ambos | Sem campo de fase da atividade (início/dev/fechamento) |
| 2 — Materiais | Ambos | **REDUNDANTE** com `materiaisNecessarios` em Recursos |
| 3 — Objetivos | Completo | **POSIÇÃO CRÍTICA:** aparece depois do roteiro |
| 4 — Classificação Pedagógica | Completo | Mistura operacional + pedagógico + metadados |
| 5 — BNCC | Completo | Textarea livre para dado estruturado; burocracia no planejamento |
| 6 — Recursos da Aula | Ambos | Mistura recursos digitais com logística física |
| 7 — Avaliação / Observações | Completo | Textarea vazio sem estrutura — não instrumentaliza reflexão |
...
## I.2 PROPOSTA CONCISA DE NOVA ESTRUTURA (Auditoria 2026-03-17)

### Modo Rápido
Título · Duração · Turma · **Músicas da aula (sobe para 1º bloco)** · Objetivo (campo único) · Roteiro **com campo de Fase** · O que preciso levar

### Modo Completo (adiciona)
Como vou avaliar (estruturado, não textarea) · Conceitos musicais · Unidades · BNCC (chips, não textarea) · Tags · Adaptações por turma · Continuidade com aula anterior

---
---

# PARTE II — AUDITORIA PROFUNDA
*Auditoria de 2026-03-18 | 16 frameworks e autores | 12 seções | Análise campo a campo*
...
# PARTE III — ADENDO: AUTORES E CONCEITOS COMPLEMENTARES
*Incorporados de pesquisa adicional e PDFs externos (2026-03-18)*
...
*(Todas as referências das duas auditorias unificadas — 38 obras)*

### Pesquisa Empírica sobre Planejamento Docente
- Clark, C. M. & Peterson, P. L. (1986). Teachers' Thought Processes. In Wittrock, M. C. (Ed.), *Handbook of Research on Teaching* (3ª ed., pp. 255–296). Macmillan.
- Tardif, M. (2002). *Saberes Docentes e Formação Profissional*. Vozes.
- Yinger, R. J. (1980). A study of teacher planning. *The Elementary School Journal*, 80(3), 107–127.

### Didática Clássica e Currículo
- Ausubel, D. P. (1968). *Educational Psychology: A Cognitive View*. Holt, Rinehart and Winston.
- Bloom, B. S. (1956). *Taxonomy of Educational Objectives: Cognitive Domain*. McKay.
- Gandin, D. (1983). *Planejamento como Prática Educativa*. Loyola.
- Hunter, M. (1982). *Mastery Teaching*. TIP Publications.
...
### Pedagogia Crítica e Sócio-Histórica (Brasil)
- Freire, P. (1970/1987). *Pedagogia do Oprimido*. Paz e Terra.
- Saviani, D. (2008). *Pedagogia Histórico-Crítica: Primeiras Aproximações* (10ª ed.). Autores Associados.
...
### Sequência Didática
- Dolz, J., Noverraz, M. & Schneuwly, B. (2004). *Sequências Didáticas para o Oral e a Escrita*. Artmed.

### Educação Musical
- Bybee, R. et al. (1989). *Science and Technology Education for the Elementary Years*. BSCS/SSEC.
- Eisner, E. W. (1994). *The Educational Imagination* (3ª ed.). Macmillan.
- Elliott, D. J. (1995). *Music Matters: A New Philosophy of Music Education*. Oxford University Press.
- Elliott, D. J. & Silverman, M. (2015). *Music Matters* (2ª ed.). Oxford University Press.
- Green, L. (2008). *Music, Informal Learning and the School: A New Classroom Pedagogy*. Ashgate.
- Reimer, B. (1970/1989/2003). *A Philosophy of Music Education*. Prentice Hall / SUNY Press.
- Swanwick, K. (1979). *A Basis for Music Education*. Nfer-Nelson.
- Swanwick, K. & Tillman, J. (1986). The sequence of musical development. *British Journal of Music Education*, 3(3), 305–339.
...
### Avaliação Formativa
- Black, P. J. & Wiliam, D. (1998). Inside the black box. *Phi Delta Kappan*, 80(2), 139–148.
- Wiliam, D. (2011). *Embedded Formative Assessment*. Solution Tree Press.

### Psicologia Cognitiva e Design de Interfaces
- Mishra, P. & Koehler, M. J. (2006). Technological Pedagogical Content Knowledge. *Teachers College Record*, 108(6), 1017–1054.
...
*Documento consolidado gerado em 2026-03-18. Arquivo: AUDITORIA-NOVA-AULA-CONSOLIDADA.md*
*Reúne as auditorias de 2026-03-17 e 2026-03-18 com adendo de pesquisa posterior.*
