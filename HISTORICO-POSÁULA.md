...
> 🟢 **IMPLEMENTADO** — 2026-03-21 · `TelaPosAulaHistorico.tsx`
> Banner condicional abaixo dos filtros. Botão `×` dispensa até reabrir. 1 insight por vez.
> Fundo `#F8FAFC` light / `#1F2937` dark · Borda esquerda `3px solid #94a3b8`.
...
| R2 | Aluno recorrente | mesmo nome em `alunoAtencao` 3+ vezes no período | "João apareceu em atenção 3 vezes em GR2B. Vale uma conversa individual?" | ✅ 🟢 |
| R3 | Turma sem registro | turma sem registro há mais de 10 dias úteis | "GR3C · Turma X não tem registro há 12 dias. Tudo bem por lá?" | ✅ 🟢 |
...
| R5 | Comportamento difícil recorrente | campo `comportamento` preenchido em 3+ aulas consecutivas na mesma turma | "GR2B teve comportamento difícil nas últimas 3 aulas. Pode ser hora de mudar a abordagem?" | ✅ 🟢 |
...
> 🟢 **IMPLEMENTADO** — 2026-03-21 · `TelaPosAulaHistorico.tsx`
> Linha pontilhada acima da lista (modo por data) e badge inline no header de cada turma (modo por turma).
...
> ❌ **REJEITADO** — 2026-03-21
> Motivo: pós-aula não é o momento para categorizar. A classificação deve vir do plano de aula e ser feita automaticamente pelo sistema (IA). Conceito válido — transferido para R6 no banco de ideias, com dependência de integração Planos + Gemini.
...
> ✅ **APROVADO com ajuste** — 2026-03-21
> 🟢 **IMPLEMENTADO** — 2026-03-21 · `TelaPosAulaHistorico.tsx`
> Ajuste: seletor de escola aparece no modo "Por turma" quando há mais de uma escola (turmas de mesmo nome em escolas diferentes).
...
## COMMITS DESTA SESSÃO (2026-03-21)
...
| `d49831e` | feat: Histórico Fase 1 — barra lateral, trecho, badges e filtros |
| *(próximo)* | feat: Histórico Fase 2 — insights, lacunas, vista por turma |

---

*Última atualização: 2026-03-21 (v3 — Fase 2 implementada: F2.1 R2/R3/R5, F2.2, F2.4)*
