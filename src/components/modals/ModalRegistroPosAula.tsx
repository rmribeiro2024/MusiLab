                                ...
                                <>
                                    {registroEditando && (
                                        <div className="flex items-center justify-between rounded-lg px-3 py-2" style={{ background: '#f8fafc', border: '1px solid #e2e8f0' }}>
                                            ...
                                            <button onClick={() => { setRegistroEditando(null); setNovoRegistro({ dataAula: new Date().toISOString().split('T')[0], resumoAula: '', funcionouBem: '', naoFuncionou: '', poderiaMelhorar: '', proximaAula: '', comportamento: '', anotacoesGerais: '' }); setRegEscolaSel(''); setRegTurmaSel('') }}
